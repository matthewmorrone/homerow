...
WordListFile := A_ScriptDir . "\one-to-one.tsv" ;path of the wordlist file
SettingsFile := A_ScriptDir . "\settings.ini" ;path of the settings file

MaxResults := 4 ;maximum number of results to display
...
ShowLength := 1 ;minimum length of word before showing suggestions
...
Gui, Show, w560 h300, Autocomplete
